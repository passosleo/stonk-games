...
const GameCard = (game) => {
  ...
  const getPlatformIcon = (platform) => {
    switch (platform) {
      case "PC (Windows)":
        return <Icon as={IoLogoWindows} w={6} h={6} color="gray.50" />;
      case "Web Browser":
        return <Icon as={BiWorld} w={6} h={6} color="gray.50" />;
      default:
        return (
          <>
  ...
  return (
    ...
    >
      <Box borderBottomWidth={1} borderColor="purple.900">
        <Link
          href={game.game_url}
          _active={{
            boxShadow: "none",
      ...
      >
        ...
        <Flex alignItems="center" justifyContent="space-between">
          ...
          <HStack>{getPlatformIcon(game.platform)}</HStack>
        </Flex>
      </Flex>
    </Flex>
  );
